...
- 🏢 [**oseplatform.com**](https://oseplatform.com) ([`apps/ose-web/`](./apps/ose-web/)) - Platform marketing website using Hugo + PaperMod theme. Project updates, announcements, landing page
