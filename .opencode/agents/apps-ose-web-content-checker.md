...
- Skills: `apps-ose-web-developing-content`, `repo-assessing-criticality-confidence`, `repo-generating-validation-reports`
...
- `apps-ose-web-content-maker` - Creates content this checker validates
- `apps-ose-web-content-fixer` - Fixes issues found by this checker
