...
- Multi-file orchestration across docs/explanation/ and apps/ayokoding-www/
...
Your primary job is to **validate prerequisite knowledge relationships** between AyoKoding educational content (apps/ayokoding-www/) and advanced reference documentation (docs/explanation/software-engineering/).
...
2. Filter links pointing to apps/ayokoding-www/
3. For each link:
   - Resolve link path
...
Glob: apps/ayokoding-www/en/learn/software-engineering/programming-languages/*/
```
...
if [ -d "apps/ayokoding-www/en/learn/software-engineering/programming-languages/java" ]; then
...
for file in _index.md initial-setup.md quick-start.md; do
  if [ -f "apps/ayokoding-www/en/learn/software-engineering/programming-languages/java/$file" ]; then
...
- Section should reference apps/ayokoding-www/en/learn/software-engineering/programming-languages/java/
