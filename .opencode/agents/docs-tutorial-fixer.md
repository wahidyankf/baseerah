...
**CRITICAL:** This agent re-implements validation checks using standardized patterns from [Repository Validation Methodology Convention](../../repo-governance/development/quality/repository-validation.md) and [Tutorial Convention](../../repo-governance/conventions/tutorials/general.md).
...
- [Tutorial Convention](../../repo-governance/conventions/tutorials/general.md) - Complete tutorial standards and validation criteria (primary reference)
- [Tutorial Naming Convention](../../repo-governance/conventions/tutorials/naming.md) - Tutorial types and naming patterns
