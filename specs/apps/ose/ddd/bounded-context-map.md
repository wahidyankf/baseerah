# Bounded Context Map — OSE

## OSE Application (`ose-app-*`)

Visual map of the five bounded contexts in OSE Application and their strategic relationships.
...
| ------------------- | -------------------------------------------------------------------------------- |
| `health`            | Liveness endpoint — stateless, no DB                                             |
...
No bounded contexts defined. `ose-web` is a content platform with no domain model beyond
content ingestion and search.

## Related

- [bounded-contexts.yaml](./bounded-contexts.yaml) — Machine-readable registry
- [ubiquitous-language/](./ubiquitous-language/README.md) — Glossaries
