# rhino — behavior/cli/gherkin/repo-governance

Gherkin scenarios for rhino-cli repository governance audit commands.

Features in this domain:

- `repo-governance-agents-md-size.feature` — agent file size audit
- `repo-governance-audit.feature` — general governance audit
- `repo-governance-emoji-audit.feature` — emoji usage audit
- `repo-governance-frontmatter-audit.feature` — frontmatter audit
- `repo-governance-layer-coherence.feature` — governance layer coherence
- `repo-governance-license-audit.feature` — license audit
- `repo-governance-readme-index-audit.feature` — README index audit
