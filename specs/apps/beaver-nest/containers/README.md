...
- [contracts/](./contracts/README.md) — OpenAPI 3.1 contract spec (`beaver-nest-contracts` Nx
  project) defining the two `beaver-nest-be` routes `beaver-nest-fe` consumes

Two runtime containers exist: `beaver-nest-fe` (Next.js, port 19310) and `beaver-nest-be` (F#/Giraffe,
