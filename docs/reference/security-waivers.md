...
| `zod`                                                              | **4.3.6**      | 2026-01-22   | CVE-2026-6991 — SQL injection in CUID handler (`packages/zod/src/v4/core/regexes.ts`). Fix in 4.4.0 (released 2026-04-29, 18 days post-cutoff). Not Path C: EPSS 0.00008 (0.008%), CVSS 6.3 Medium, not in CISA KEV. Upgrade to ≥ 4.4.0 when its 60-day soak window opens (on or after 2026-06-29). | Medium (CVSS 6.3) | N   | 0.00008 | [CVE-2026-6991 NVD](https://nvd.nist.gov/vuln/detail/CVE-2026-6991), [GHSA-hprg-jrj6-qhrw](https://github.com/advisories/GHSA-hprg-jrj6-qhrw) | [`standardize-secrets-and-env`](../../plans/in-progress/standardize-secrets-and-env/) | plan-author                            |
