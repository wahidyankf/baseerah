...
You MUST complete the AyoKoding Playwright Learning Path before using these standards.

- Playwright Initial Setup - Environment and tooling setup
- Playwright Overview - Auto-waiting, cross-browser support, trace viewer
- Playwright By Example (85+ annotated examples) - Hands-on code learning
...
Playwright usage in this platform follows the software engineering principles from [repo-governance/principles/software-engineering/](../../../../../../repo-governance/principles/software-engineering/README.md):
