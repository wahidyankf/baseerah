...
- **C4 Architecture Model Learning Path** - Educational foundation for C4 visualization
- **C4 Architecture Model Overview** - Core C4 concepts (Context, Container, Component, Code)
- **C4 Architecture Model By Example** - Practical C4 diagram examples
