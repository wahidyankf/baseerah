...
- **Hexagonal Architecture FP Tutorial** — Educational foundation: partial application as dependency injection
- **Hexagonal Architecture OOP Tutorial** — Educational foundation: constructor injection wiring
