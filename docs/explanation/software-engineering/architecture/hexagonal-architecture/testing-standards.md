...
- **Hexagonal Architecture FP Tutorial** — Educational foundation: adapter swap for test isolation
- **Hexagonal Architecture OOP Tutorial** — Educational foundation: port contract tests with abstract base classes
