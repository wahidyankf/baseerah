...
**REQUIRED**: Complete Hexagonal Architecture Overview before using these standards. These are **OSE Platform-specific port conventions**, not port concept tutorials.
...
- **Hexagonal Architecture FP Tutorial** — Educational foundation for F# port type aliases
- **Hexagonal Architecture OOP Tutorial** — Educational foundation for Java port interfaces
