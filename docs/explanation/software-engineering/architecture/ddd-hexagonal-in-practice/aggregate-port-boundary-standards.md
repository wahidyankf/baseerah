...
**REQUIRED**: Complete [DDD Aggregate Standards](../domain-driven-design-ddd/aggregate-standards.md), [Port Standards](../hexagonal-architecture/port-standards.md), and Cases before applying these standards.
...
**See**: [Port Standards — Standard 1](../hexagonal-architecture/port-standards.md) for port ownership rules. Cases — In OOP Beginner for a worked example.
...
- **Cases — In OOP** — Production Java wiring of aggregates through ports
- **Cases — In FP** — Production F# wiring of aggregates through ports
