...
- **DDD fundamentals** — Domain-Driven Design Learning Path
- **Hexagonal fundamentals** — Hexagonal Architecture Overview
- **DDD + Hexagonal in Production** — Cases (In FP and In OOP cases)
...
**See**: Cases for the educational counterpart with worked production examples.
...
- **Cases — In FP** — Production F#/Giraffe case
- **Cases — In OOP** — Production Java/Spring Boot case
