...
**See**: [DDD + Hexagonal Tutorials — Bounded Context Wiring](../../../../../apps/ayokoding-web/content/en/learn/software-engineering/software-architecture/by-example/cases/in-oop/beginner.md) for a worked example.
