...
**REQUIRED**: Complete [DDD Bounded Context Standards](../domain-driven-design-ddd/bounded-context-standards.md), Hexagonal Architecture Overview, and Cases Overview before applying these standards.
...
**See**: DDD + Hexagonal Tutorials — Bounded Context Wiring for a worked example.
