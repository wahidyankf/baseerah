...
- **[apps-beaver-nest-fe-content-maker](apps-beaver-nest-fe-content-maker.md)** - Creates and updates beaver-nest-fe landing-page copy (tagline, footer, not-found/error text)
...
- **[apps-beaver-nest-fe-content-checker](apps-beaver-nest-fe-content-checker.md)** - Validates beaver-nest-fe landing-page content quality (accessibility, token usage, documented content surface)
...
- **[apps-beaver-nest-fe-content-fixer](apps-beaver-nest-fe-content-fixer.md)** - Apply validated beaver-nest-fe content fixes
...
- **[apps-beaver-nest-fe-deployer](apps-beaver-nest-fe-deployer.md)** - Force-pushes main to `prod-beaver-nest-fe` for beaver-nest-fe production deploys. No production target is provisioned yet — documents the intended workflow ahead of that provisioning.
- **[apps-beaver-nest-be-deployer](apps-beaver-nest-be-deployer.md)** - Force-pushes main to `stag-beaver-nest-be`, triggering the existing image-build CI job. No running staging server consumes the image yet.
...
| `deployer`   | Deploys an application to an environment                                               | `apps-beaver-nest-fe-deployer`, `apps-beaver-nest-be-deployer`                                  |
