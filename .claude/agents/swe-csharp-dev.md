...
- **[docs/explanation](../../docs/explanation/software-engineering/programming-languages/c-sharp/)** - "How to code C# in OSE Platform" (repository conventions, framework choices) — the sole in-repo authority; `ose-public` carries no educational C# tutorial tree
