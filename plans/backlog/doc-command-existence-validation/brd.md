...
| **`nx-targets.md` aspirational entries force fabrication** | Medium   | Remediation splits the table into "exists" and "planned", the latter exempt-annotated — honest labelling rather than invented tooling                                                           |
