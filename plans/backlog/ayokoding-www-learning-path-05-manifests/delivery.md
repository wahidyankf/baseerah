...
Worktree path: `worktrees/ayokoding-www-learning-path-05-manifests/`

Optional manual pre-provisioning (run from repo root):

```bash
claude --worktree ayokoding-www-learning-path-05-manifests
```
...
(`git fetch origin && git checkout main && git pull && git checkout -b ayokoding-www-learning-path-05-manifests/<phase-slug>`),
...
| ----------- | ------------------------------------------------------------------------- |
| `blockedBy` | `ayokoding-www-learning-path-03-navigation-ui`                            |
| `blockedBy` | `ayokoding-www-learning-path-04-course-authoring`                         |
| `blockedBy` | `ayokoding-www-learning-path-01-url-restructure` (transitive)             |
| `blockedBy` | `ayokoding-www-learning-path-02-schema-and-prerequisite-dag` (transitive) |
...
- [ ] [AI] **Start precondition 1** — confirm the navigation plan is merged:
      `gh pr list --search "ayokoding-www-learning-path-03-navigation-ui" --state merged --json number --jq 'length'`
...
- [ ] [AI] **Start precondition 2** — confirm the course-authoring plan is merged:
      `gh pr list --search "ayokoding-www-learning-path-04-course-authoring" --state merged --json number --jq 'length'`
...
- [ ] [AI] **Syllabus mirror reachability** — confirm the four authoritative orderings are readable
      ...
      `ls ../ayokoding-www-learning-path-02-schema-and-prerequisite-dag/syllabus/paths/manifest-*.md | wc -l`
...
- [ ] [AI] **GREEN** — author `<MANIFESTS>interview-ready/software-engineer.yaml` _(new file)_ with
      ...
      [`../ayokoding-www-learning-path-02-schema-and-prerequisite-dag/syllabus/paths/manifest-interview-ready-software-engineer.md`](../ayokoding-www-learning-path-02-schema-and-prerequisite-dag/syllabus/paths/manifest-interview-ready-software-engineer.md),
...
- [ ] [AI] Populate the first paths-hub card in `<PATHS>_index.md` _(existing file, created by
      `ayokoding-www-learning-path-01-url-restructure`)_ — add the `interview-ready` card to the 2×2
...
- [ ] [AI] **RED** — add the coexistence scenario to
      ...
      `ayokoding-www-learning-path-03-navigation-ui`)_ asserting that a course reached from this path's
...
- [ ] [AI] **GREEN** — author
      ...
      [`../ayokoding-www-learning-path-02-schema-and-prerequisite-dag/syllabus/paths/manifest-immediately-effective-software-engineer-to-ai-engineer.md`](../ayokoding-www-learning-path-02-schema-and-prerequisite-dag/syllabus/paths/manifest-immediately-effective-software-engineer-to-ai-engineer.md)
...
- [ ] [AI] **GREEN** — author `<MANIFESTS>immediately-effective/software-engineer.yaml` _(new file)_
      ...
      [`../ayokoding-www-learning-path-02-schema-and-prerequisite-dag/syllabus/paths/manifest-immediately-effective-software-engineer.md`](../ayokoding-www-learning-path-02-schema-and-prerequisite-dag/syllabus/paths/manifest-immediately-effective-software-engineer.md)
      — command: `npx nx run ayokoding-www:test:unit`
...
- [ ] [AI] **GREEN** — author `<MANIFESTS>fundamentally-strong/software-engineer.yaml` _(new file)_
      ...
      ordered `courseOrder` transcribed from
      [`../ayokoding-www-learning-path-02-schema-and-prerequisite-dag/syllabus/paths/manifest-fundamentally-strong-software-engineer.md`](../ayokoding-www-learning-path-02-schema-and-prerequisite-dag/syllabus/paths/manifest-fundamentally-strong-software-engineer.md)
      — command: `npx nx run ayokoding-www:test:unit`
...
> **Absorbed from `ayokoding-www-learning-path-04-course-authoring` per the manifest ownership
...
- [ ] [AI] Once the harness cluster (`creating-ai-powered-apps`, `agentic-ai`,
      ...
      [manifest mirror](../ayokoding-www-learning-path-02-schema-and-prerequisite-dag/syllabus/paths/manifest-immediately-effective-software-engineer-to-ai-engineer.md),
...
- [ ] [AI] **Cross-plan link check (this plan's own folder)** —
      `cargo run --release --manifest-path apps/rhino-cli/Cargo.toml -- md links validate --exclude plans/done --exclude apps/ayokoding-www/content --exclude apps/ose-www/content 2>&1 | grep -F "ayokoding-www-learning-path-05-manifests"`
...
- [ ] [AI] Confirm no plan PR is still open:
      `gh pr list --search "ayokoding-www-learning-path-05-manifests" --state open --json number --jq 'length'`
...
- [ ] [AI] **Terminal four-manifest and 127-catalog assertion** — verify all four path manifests are
      ...
      **4**, AND `find <COURSES> -maxdepth 1 -mindepth 1 -type d | wc -l` returns **127**, AND
      ...
      this plan and `ayokoding-www-learning-path-04-course-authoring`, and it belongs **here**: that plan
...
- [ ] [AI] **Scoped cross-plan link check** — re-run the Phase 6 filtered link validation and confirm
      ...
      `ayokoding-www-learning-path-02-schema-and-prerequisite-dag` has archived since, confirm every
      ...
      `All links valid! No broken links found.`
- [ ] [AI] Move: `git mv plans/in-progress/ayokoding-www-learning-path-05-manifests plans/done/YYYY-MM-DD__ayokoding-www-learning-path-05-manifests`
...
- [ ] [AI] Commit the archival: `chore(plans): move ayokoding-www-learning-path-05-manifests to done`.
...
- [ ] [AI] Plan folder is under `plans/done/YYYY-MM-DD__ayokoding-www-learning-path-05-manifests`; every
