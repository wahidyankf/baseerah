...
| `ayokoding-learning-path-04-course-authoring`                                     | 37 re-homed course bundles occupying the flat `courses/` namespace                                                               | the 29-new-slug collision check is only meaningful against a populated namespace                                                        |
