...
| The DD-47 render matrix is read as under-delivered, or is "fixed" by duplicating renders across plans.    | The 36/6 split (amended 2026-07-21 from 24/6 by the category-split ruling) is stated in DL-17's amendment note, beside the Phase-1 gate clause, and again in the archival gate. Copying the other plan's six renders into this folder is explicitly forbidden — two copies of one matrix drift. |
