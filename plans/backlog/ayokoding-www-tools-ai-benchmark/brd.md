...
roster, and those rosters move constantly. Between 2026-07-01 and 2026-07-24 alone, five
frontier models shipped (Claude Fable 5, Grok 4.5, the GPT-5.6 family, Kimi K3, Claude Opus 5)
`[Web-cited — see tech-docs.md §Appendix A, accessed 2026-07-28]`. Third-party leaderboards have not
...
| **Licensing.** Leaderboard operators publish under mixed terms; Artificial Analysis' ToU restrict copying its site, and Terminal-Bench and ARC Prize state no republication terms                                               | Takedown request or licence breach                                     | Cite per figure, link back to each operator, reproduce no operator's compiled table wholesale, and carry a Sources and Licences section naming each operator's terms                                              |
| **Staleness.** The field moved five frontier models in four weeks                                                                                                                                                               | The page misleads within weeks of shipping                             | Visible `snapshotDate`, per-field source URLs, and a runbook that makes a refresh a bounded task; explicitly no time-dependent staleness banner, which would break SSR determinism                                |
