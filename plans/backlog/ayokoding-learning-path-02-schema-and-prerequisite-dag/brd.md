...
| **The `syllabus/` corpus is copied into a consuming plan instead of linked, forking 121 specs.**                                                                                                                                                                                                                                                                                                                     | The custody rule is stated in this plan's `README.md` and restated as a `> **Cross-plan source of truth**` blockquote in each sibling plan's README. A copy is a boundary violation, not a convenience.                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
