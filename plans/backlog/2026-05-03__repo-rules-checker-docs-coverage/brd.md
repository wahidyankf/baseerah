...
| `npm run generate:bindings` fails to sync the modified agent body                                                           | Low                         | `.opencode/agents/repo-rules-checker.md` falls out of sync                                                        | Run `npx nx run rhino-cli:validate:cross-vendor-parity` post-sync; gate prevents merge while drift remains                                                                                 |
