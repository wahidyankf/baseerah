...
| `ayokoding-learning-path-04-course-authoring`                           | the fourth path's new AI course bodies                                                                                                                 | the fourth path's spine references these; per [tech-docs DD-35](./tech-docs.md#design-decisions) the exact spine size is an open item pending the AI/harness cluster's own Phase 5 growth (`ayokoding-learning-path-02-schema-and-prerequisite-dag`'s syllabus-mirror update — the rename, content correction, and Phase 1.4 ordering — has already landed and is archived), not fixed at six |
...
- [Syllabus (cross-plan, read-only)](../../done/2026-07-24__ayokoding-learning-path-02-schema-and-prerequisite-dag/syllabus/README.md) —
  ...
  ordering of the newly included courses was landed at that plan's own Phase 1.4, now archived — see
  tech-docs).
