...
| `apps/ayokoding-www/src/features/course-paths/manifests/careers/careers-manifests.unit.test.ts` | test    | asserts every published `careers/` manifest's shape, integrity, and growth state — **not shared**: plans 06 and 07 each own their own scoped manifest test (ruled 2026-07-21)                                           |
