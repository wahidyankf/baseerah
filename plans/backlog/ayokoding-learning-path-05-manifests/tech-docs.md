...
| `apps/ayokoding-www/src/features/course-paths/manifests/careers-manifests.unit.test.ts` | test    | asserts every published `careers/` manifest's shape, integrity, and growth state — this file itself is shared once `ayokoding-learning-path-06-skills-accounting` and `ayokoding-learning-path-07-skills-erp` add their own assertions alongside |
...
| Path                                                                                                          | Change                                                 | Phase      |
| ------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------ | ---------- |
| `apps/ayokoding-www/src/features/course-paths/manifests/careers-manifests.unit.test.ts`                       | created (Phase 1), extended (2, 3, 4)                  | 1-4        |
