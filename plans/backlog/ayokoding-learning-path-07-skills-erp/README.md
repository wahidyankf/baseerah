...
[`syllabus/README.md`](../ayokoding-learning-path-02-schema-and-prerequisite-dag/syllabus/README.md)
...
gate is declared; `[AI]` merges every phase once the PR-Review Maker→Fixer Cycle and CI are green.
