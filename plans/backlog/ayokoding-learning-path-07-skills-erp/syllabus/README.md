...
Per-course module/topic breakdowns for the 29-course ERP corpus (DD-31 in
...
| 21  | [`erp-extension-and-customization`](./courses/erp-extension-and-customization.md)                         | By Example        |
| 22  | [`erp-integration-patterns`](./courses/erp-integration-patterns.md)                                       | By Example        |

## Stage B — Conventional Enterprise Depth (11 courses, gated on accounting's conventional-accounting boundary)
...
| 23  | [`human-capital-management-and-hire-to-retire`](./courses/human-capital-management-and-hire-to-retire.md) | Annotated-concept |
| 24  | [`multi-company-and-multi-currency-erp`](./courses/multi-company-and-multi-currency-erp.md)               | By Example        |
| 25  | [`erp-security-and-controls`](./courses/erp-security-and-controls.md)                                     | Annotated-concept |
| 26  | [`erp-analytics-and-reporting`](./courses/erp-analytics-and-reporting.md)                                 | By Example        |

**Dangerous 3 ⚡ — `conventional-erp` ENDS HERE** (26 courses).

## Stage C — Sharia-Compliant Design (3 courses, `sharia-erp` only, gated on accounting's sharia-accounting boundary)

| #   | Course id                                                                                           | Format            |
| --- | --------------------------------------------------------------------------------------------------- | ----------------- |
| 27  | [`sharia-compliant-erp-design`](./courses/sharia-compliant-erp-design.md)                           | Annotated-concept |
| 28  | [`islamic-contract-based-transaction-flows`](./courses/islamic-contract-based-transaction-flows.md) | By Example        |
| 29  | [`zakat-and-sharia-compliance-modules`](./courses/zakat-and-sharia-compliance-modules.md)           | Annotated-concept |

**Dangerous 4 ⚡ — `sharia-erp` ENDS HERE** (29 courses).

## Path mirrors

- [`paths/manifest-skills-conventional-erp.md`](./paths/manifest-skills-conventional-erp.md) — the
  authoritative 26-id ordering `<CONVMAN>`'s `courseOrder` is transcribed from.
- [`paths/manifest-skills-sharia-erp.md`](./paths/manifest-skills-sharia-erp.md) — the authoritative
  29-id ordering `<SHARMAN>`'s `courseOrder` is transcribed from.

## A6 / A7 stay in force here

No module in any of the 29 syllabus files below asks the reader to build, install, or stand up a
