# Domain-Driven Design (By Example, Python) — carried-over course
...
The full worked content for `domain-driven-design` (Concepts `co-NN`, Worked examples `ex-NN`, and the intra-course
Capstone spec) lives in the sibling plan and is the **single source of truth**:

- [`43-domain-driven-design.md`](../../../in-progress/fundamentally-strong-software-engineer/syllabus/43-domain-driven-design.md)
