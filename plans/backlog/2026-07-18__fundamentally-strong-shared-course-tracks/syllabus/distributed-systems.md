# Distributed Systems (By Example, Python) — carried-over course
...
The full worked content for `distributed-systems` (Concepts `co-NN`, Worked examples `ex-NN`, and the intra-course
Capstone spec) lives in the sibling plan and is the **single source of truth**:

- [`46-distributed-systems.md`](../../../in-progress/fundamentally-strong-software-engineer/syllabus/46-distributed-systems.md)
