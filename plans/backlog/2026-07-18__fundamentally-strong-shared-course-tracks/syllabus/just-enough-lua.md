# Just Enough Lua (Primer, Lua) — carried-over course
...
The full worked content for `just-enough-lua` (Concepts `co-NN`, Worked examples `ex-NN`, and the intra-course
Capstone spec) lives in the sibling plan and is the **single source of truth**:

- [`02-just-enough-lua.md`](../../../in-progress/fundamentally-strong-software-engineer/syllabus/02-just-enough-lua.md)
