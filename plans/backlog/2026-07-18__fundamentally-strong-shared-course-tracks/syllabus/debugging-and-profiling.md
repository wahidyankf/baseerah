# Debugging and Profiling (By Example, Python + native) — carried-over course
...
The full worked content for `debugging-and-profiling` (Concepts `co-NN`, Worked examples `ex-NN`, and the intra-course
Capstone spec) lives in the sibling plan and is the **single source of truth**:

- [`16-debugging-and-profiling.md`](../../../in-progress/fundamentally-strong-software-engineer/syllabus/16-debugging-and-profiling.md)
