# Just Enough Bash (Primer, Bash/shell) — carried-over course
...
The full worked content for `just-enough-bash` (Concepts `co-NN`, Worked examples `ex-NN`, and the intra-course
Capstone spec) lives in the sibling plan and is the **single source of truth**:

- [`05-just-enough-bash.md`](../../../in-progress/fundamentally-strong-software-engineer/syllabus/05-just-enough-bash.md)
