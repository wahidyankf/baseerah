...
The full worked content for `just-enough-c` (Concepts `co-NN`, Worked examples `ex-NN`, and the intra-course
Capstone spec) lives in the sibling plan and is the **single source of truth**:

- [`78-just-enough-c.md`](../../../in-progress/fundamentally-strong-software-engineer/syllabus/78-just-enough-c.md)
