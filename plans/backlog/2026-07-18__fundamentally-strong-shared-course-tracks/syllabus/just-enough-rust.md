# Just Enough Rust (Primer, Rust) — carried-over course
...
The full worked content for `just-enough-rust` (Concepts `co-NN`, Worked examples `ex-NN`, and the intra-course
Capstone spec) lives in the sibling plan and is the **single source of truth**:

- [`82-just-enough-rust.md`](../../../in-progress/fundamentally-strong-software-engineer/syllabus/82-just-enough-rust.md)
