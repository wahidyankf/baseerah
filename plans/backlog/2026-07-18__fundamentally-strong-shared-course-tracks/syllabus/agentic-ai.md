# Agentic AI (By Example, Python) — carried-over course
...
The full worked content for `agentic-ai` (Concepts `co-NN`, Worked examples `ex-NN`, and the intra-course
Capstone spec) lives in the sibling plan and is the **single source of truth**:

- [`57-agentic-ai.md`](../../../in-progress/fundamentally-strong-software-engineer/syllabus/57-agentic-ai.md)
