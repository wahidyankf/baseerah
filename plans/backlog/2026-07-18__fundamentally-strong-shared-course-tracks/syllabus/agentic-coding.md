# Agentic Coding (Annotated-concept, polyglot) — carried-over course
...
The full worked content for `agentic-coding` (Concepts `co-NN`, Worked examples `ex-NN`, and the intra-course
Capstone spec) lives in the sibling plan and is the **single source of truth**:

- [`31-agentic-coding.md`](../../../in-progress/fundamentally-strong-software-engineer/syllabus/31-agentic-coding.md)
