# Modern System Programming (By Example, Rust) — carried-over course

**Course ID**: `modern-system-programming` · **Format**: By Example · **Language**: Rust.
...
**Short summary**: Safe, high-performance systems programming
