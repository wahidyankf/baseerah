# Advanced Algorithms (By Example, Python) — carried-over course
...
The full worked content for `advanced-algorithms` (Concepts `co-NN`, Worked examples `ex-NN`, and the intra-course
Capstone spec) lives in the sibling plan and is the **single source of truth**:

- [`25-advanced-algorithms.md`](../../../in-progress/fundamentally-strong-software-engineer/syllabus/25-advanced-algorithms.md)
