# System Programming (By Example, C) — carried-over course
...
The full worked content for `system-programming` (Concepts `co-NN`, Worked examples `ex-NN`, and the intra-course
Capstone spec) lives in the sibling plan and is the **single source of truth**:

- [`81-system-programming.md`](../../../in-progress/fundamentally-strong-software-engineer/syllabus/81-system-programming.md)
