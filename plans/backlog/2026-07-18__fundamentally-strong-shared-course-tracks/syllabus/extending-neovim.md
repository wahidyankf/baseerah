# Extending Neovim (By Example, Lua) — carried-over course

**Course ID**: `extending-neovim` · **Format**: By Example · **Language**: Lua.
...
**Short summary**: Neovim config, plugins, LSP, keymaps in Lua

## Authored content — source of truth

The full worked content for `extending-neovim` (Concepts `co-NN`, Worked examples `ex-NN`, and the intra-course
