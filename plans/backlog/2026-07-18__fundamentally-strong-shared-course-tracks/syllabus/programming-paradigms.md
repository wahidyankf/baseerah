# Programming Paradigms (By Example, Python) — carried-over course
...
The full worked content for `programming-paradigms` (Concepts `co-NN`, Worked examples `ex-NN`, and the intra-course
Capstone spec) lives in the sibling plan and is the **single source of truth**:

- [`22-programming-paradigms.md`](../../../in-progress/fundamentally-strong-software-engineer/syllabus/22-programming-paradigms.md)
