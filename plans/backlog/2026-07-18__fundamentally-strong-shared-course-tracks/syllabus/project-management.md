# Project Management (Annotated-concept, — (concept, no code)) — carried-over course
...
The full worked content for `project-management` (Concepts `co-NN`, Worked examples `ex-NN`, and the intra-course
Capstone spec) lives in the sibling plan and is the **single source of truth**:

- [`09-project-management.md`](../../../in-progress/fundamentally-strong-software-engineer/syllabus/09-project-management.md)
