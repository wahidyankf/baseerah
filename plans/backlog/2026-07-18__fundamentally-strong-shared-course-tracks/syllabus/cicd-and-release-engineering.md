# CI/CD and Release Engineering (By Example, YAML + Python) — carried-over course
...
The full worked content for `cicd-and-release-engineering` (Concepts `co-NN`, Worked examples `ex-NN`, and the intra-course
Capstone spec) lives in the sibling plan and is the **single source of truth**:

- [`55-cicd-and-release-engineering.md`](../../../in-progress/fundamentally-strong-software-engineer/syllabus/55-cicd-and-release-engineering.md)
