# Computer Architecture (By Example, C) — carried-over course
...
The full worked content for `computer-architecture` (Concepts `co-NN`, Worked examples `ex-NN`, and the intra-course
Capstone spec) lives in the sibling plan and is the **single source of truth**:

- [`20-computer-architecture.md`](../../../in-progress/fundamentally-strong-software-engineer/syllabus/20-computer-architecture.md)
