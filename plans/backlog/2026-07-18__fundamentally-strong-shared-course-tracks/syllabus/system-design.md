# System Design (Annotated-concept, Python) — carried-over course
...
The full worked content for `system-design` (Concepts `co-NN`, Worked examples `ex-NN`, and the intra-course
Capstone spec) lives in the sibling plan and is the **single source of truth**:

- [`44-system-design.md`](../../../in-progress/fundamentally-strong-software-engineer/syllabus/44-system-design.md)
