# Containers and Orchestration (By Example, YAML/CLI) — carried-over course
...
The full worked content for `containers-and-orchestration` (Concepts `co-NN`, Worked examples `ex-NN`, and the intra-course
Capstone spec) lives in the sibling plan and is the **single source of truth**:

- [`50-containers-and-orchestration.md`](../../../in-progress/fundamentally-strong-software-engineer/syllabus/50-containers-and-orchestration.md)
