# Functional Programming (By Example, Python) — carried-over course
...
The full worked content for `functional-programming` (Concepts `co-NN`, Worked examples `ex-NN`, and the intra-course
Capstone spec) lives in the sibling plan and is the **single source of truth**:

- [`23-functional-programming.md`](../../../in-progress/fundamentally-strong-software-engineer/syllabus/23-functional-programming.md)
