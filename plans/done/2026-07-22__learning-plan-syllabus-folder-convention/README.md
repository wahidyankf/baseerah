...
[diagrams.md §UI Mockups in Plan Docs](../../../repo-governance/conventions/formatting/diagrams.md#ui-mockups-in-plan-docs)
`[Repo-grounded]`, referenced from
[plans.md §Multi-File Structure](../../../repo-governance/conventions/structure/plans.md#multi-file-structure)
