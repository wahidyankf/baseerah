...
- **Validator gates lie when reality lies.** `validate-tree`, `validate-counts`, `validate-links`,
  ...
  [specs-directory-structure.md §Pre-push + CI gating surfaces](../../../repo-governance/conventions/structure/specs-directory-structure.md#pre-push--ci-gating-surfaces).
