...
- **`plan-execution.md` §8, "Archival-in-PR"** — the rule with the gap; states the delivering-PR
  ...
  [plan-execution.md §8](../../repo-governance/workflows/plan/plan-execution.md#8-finalization-and-archival-sequential)
...
- **The Plan-Docs-Only Carve-Out** — the existing partial mitigation this plan leans on for its
  ...
  non-precedent.
  [plan-planning.md §The Plan-Docs-Only Carve-Out](../../repo-governance/workflows/plan/plan-planning.md#the-plan-docs-only-carve-out)
