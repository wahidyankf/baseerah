...
- [ayokoding-mermaid-diagram-remediation](./ayokoding-mermaid-diagram-remediation.md) — 644 mermaid violations exposed by the `detect_kind` fix; remediate and drop the temporary CI exclude.
