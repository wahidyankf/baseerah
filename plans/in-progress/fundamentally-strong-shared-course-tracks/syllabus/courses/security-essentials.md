# Security Essentials (By Example, Python)
...
[`58-it-and-application-security`](./it-and-application-security.md) and [`60-defensive-security`](./defensive-security.md) (DD-11).
...
- **Prior topics**: [topic 4 Just Enough Python](./just-enough-python.md),
  [topic 10 SQL Essentials](./sql-essentials.md) (SQL-injection examples), and
  [topic 11 Backend Essentials](./backend-essentials.md) — the HTTP service you built there is the
...
> _Content originated in the now-closed FS-SE plan (topic 17); it now lives here in
