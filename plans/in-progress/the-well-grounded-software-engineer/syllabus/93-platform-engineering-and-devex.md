# 93 · Platform Engineering & Developer Experience (Annotated-concept, ‡ no-code)

**prd row**: Pass 5 · Internals & Lead at Altitude · Annotated-concept · ‡ no-code · Learn 193 / Drill 293 ·
...
[`51-cloud-and-iac`](./51-cloud-and-iac.md), and [`55-cicd-and-release-engineering`](./55-cicd-and-release-engineering.md)
...
- Platform engineering is the current synthesis of two prior swings. First, siloed Dev-throws-to-Ops created
  ...
  paved road feed directly into [`94-site-reliability-engineering`](./94-site-reliability-engineering.md),
...
← Previous: [92 · Build Your Own Raft / Replicated KV](./92-build-your-own-raft.md) · Next: [94 · Site Reliability Engineering](./94-site-reliability-engineering.md) →
