# 55 · CI/CD & Release Engineering (By Example, YAML + Python †)

**prd row**: Pass 3 · Build for the Real World · By Example · YAML + Python † · Learn 155 / Drill 255 ·
...
- **co-34 · automated-canary-analysis** — controllers that drive the rollout from live metric analysis rather
  ...
  form of progressive delivery (ties to [`53-self-managed-kubernetes-and-gitops`](./53-self-managed-kubernetes-and-gitops.md)).
