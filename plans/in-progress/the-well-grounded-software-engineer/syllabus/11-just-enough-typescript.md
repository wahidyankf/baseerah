# 11 · Just Enough TypeScript (Primer, TypeScript †)

**prd row**: Pass 1 · First Working Software · Primer · TypeScript † · Learn 111 / Drill 211 · Nvim-ready
...
[`12-frontend-essentials`](./12-frontend-essentials.md) / [`29-advanced-frontend`](./29-advanced-frontend.md)
and the TS side of [`13-software-testing`](./13-software-testing.md). Node/TS are Tier-1 OSS (DD-21).

## Prerequisites

- **Prior topics**: [topic 01 Just Enough Nvim](./01-just-enough-nvim.md) (to edit/run); prior
  programming maturity from [topic 04 Just Enough Python](./04-just-enough-python.md) helps but is not
  required.
...
← Previous: [10 · Networking Essentials](./10-networking-essentials.md) · Next: [12 · Frontend Essentials](./12-frontend-essentials.md) →
