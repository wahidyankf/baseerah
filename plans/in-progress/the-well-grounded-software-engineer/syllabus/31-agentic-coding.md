...
**prd row**: Pass 2 · Depth, Design & Craft · Annotated-concept · ‡ polyglot · Learn 131 / Drill 231 · Nvim-ready Yes · VSCode-ready Yes. ([prd canonical table](../prd.md#the-94-topics--canonical-table-spiral-order-identical-in-both-tracks))
...
revisited in the AI band at [`57-agentic-ai`](./57-agentic-ai.md).
...
- Assisted coding evolved from autocomplete to snippet generators to agents that read a repo, plan,
  ...
  [`57-agentic-ai`](./57-agentic-ai.md), which flips the perspective from _using_ agents to _building_
