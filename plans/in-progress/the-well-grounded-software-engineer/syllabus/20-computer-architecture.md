...
**prd row**: Pass 2 · Depth, Design & Craft · By Example · C † · Learn 120 / Drill 220 · Nvim-ready Yes · VSCode-ready Yes. ([prd canonical table](../prd.md#the-94-topics--canonical-table-spiral-order-identical-in-both-tracks))
...
visible rather than hidden. Builds on [`19-computer-science-foundations`](./19-computer-science-foundations.md).
...
- Programmers once reasoned about a flat, uniform memory and a CPU that executed one instruction at a
  ...
  mechanical-sympathy foundation feeds the systems-programming topics — [`82-just-enough-rust`](./82-just-enough-rust.md)
