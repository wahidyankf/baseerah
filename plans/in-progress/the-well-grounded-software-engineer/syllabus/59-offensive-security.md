...
driving standard tooling (nmap, sqlmap, Burp/ZAP). Pairs with [`60-defensive-security`](./60-defensive-security.md)
(the blue-team counterpart) and applies [`58-it-and-application-security`](./58-it-and-application-security.md).
...
← Previous: [58 · IT / Application Security](./58-it-and-application-security.md) · Next: [60 · Defensive Security](./60-defensive-security.md) →
