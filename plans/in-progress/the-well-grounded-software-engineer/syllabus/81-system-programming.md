# 81 · System Programming (By Example, C †)

**prd row**: Pass 4 · Concurrency & Systems · By Example · C † · Learn 181 / Drill 281 ·
...
Builds on the OS topics ([`79-linux-os`](./79-linux-os.md)) and the CS memory foundations
...
← Previous: [80 · Windows OS](./80-windows-os.md) · Next: [82 · Just Enough Rust](./82-just-enough-rust.md) →
