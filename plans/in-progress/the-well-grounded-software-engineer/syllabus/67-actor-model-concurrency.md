# 67 · Actor-Model Concurrency (By Example, Elixir †)

**prd row**: Pass 4 · Concurrency & Systems · By Example · Elixir † · Learn 167 / Drill 267 ·
...
contrast with CSP ([`65-csp-style-concurrency`](./65-csp-style-concurrency.md)). License-aware (DD-15).
...
- **co-26 · actor-vs-csp** — the actor model (identity-addressed processes, async mailboxes, supervision)
  contrasts with CSP ([`65-csp-style-concurrency`](./65-csp-style-concurrency.md): anonymous processes,
...
← Previous: [66 · Just Enough Elixir](./66-just-enough-elixir.md) · Next: [68 · Just Enough Kotlin](./68-just-enough-kotlin.md) →
