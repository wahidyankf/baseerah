...
- **Dynamic memory** — `[Verified]` `malloc`/`free` (`<stdlib.h>`) are the standard heap primitives; kept at
  ...
  [`81-system-programming`](./81-system-programming.md).
...
← Previous: [77 · Building Production CLI Tools](./77-building-production-cli-tools.md) · Next: [79 · Linux OS](./79-linux-os.md) →
