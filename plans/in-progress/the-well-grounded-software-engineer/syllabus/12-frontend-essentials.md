# 12 · Frontend Essentials (By Example, TypeScript †)

**prd row**: Pass 1 · First Working Software · By Example · TypeScript † · Learn 112 / Drill 212 ·
...
[`29-advanced-frontend`](./29-advanced-frontend.md) (DD-11). WCAG AA intro here (Accessibility First).

## Prerequisites

- **Prior topics**: [topic 11 Just Enough TypeScript](./11-just-enough-typescript.md) (all UI code is
  typed TS); applied testing cross-refs [topic 13 Software Testing](./13-software-testing.md).
...
- **Assumed knowledge**: TypeScript basics (types, unions, async) from topic 11; willingness to learn
...
← Previous: [11 · Just Enough TypeScript](./11-just-enough-typescript.md) · Next: [13 · Software Testing](./13-software-testing.md) →
