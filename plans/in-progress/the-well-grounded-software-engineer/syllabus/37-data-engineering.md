...
path is [`53-creating-ai-powered-apps`](./53-creating-ai-powered-apps.md).
...
- Streaming ingestion: a log-based broker (Kafka) — topics, partitions, offsets, consumer groups — and
  windowed vs stateless stream processing.
