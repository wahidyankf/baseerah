# 34 · NoSQL Databases (By Example, Python †)

**prd row**: Pass 3 · Build for the Real World · By Example · Python † · Learn 134 / Drill 234 ·
...
own topic ([`35-graph-databases`](./35-graph-databases.md)). License-awareness (DD-15) is treated as a
real engineering step. Relational depth is [`26-advanced-sql-and-query-performance`](./26-advanced-sql-and-query-performance.md).
...
- **Prior topics**: [topic 10 SQL Essentials](./10-sql-essentials.md) (the relational model these contrast
  against) and [topic 4 Just Enough Python](./04-just-enough-python.md);
  [topic 26 Advanced SQL](./26-advanced-sql-and-query-performance.md) sharpens the modeling contrast.
...
- **co-01 · nosql-family-taxonomy** — key-value, document, wide-column, and time-series stores optimize
  different access shapes and trade-offs; graph is covered separately in [topic 35](./35-graph-databases.md).
...
← Previous: [33 · Engineering Management](./33-engineering-management.md) · Next: [35 · Graph Databases](./35-graph-databases.md) →
