...
- **Concurrency preview** — Effective Go: "Prefix a function or method call with the `go` keyword to run the
  ...
  detector) is deferred to [`65-csp-style-concurrency`](./65-csp-style-concurrency.md).
...
← Previous: [63 · Analytics & Experimentation](./63-analytics-and-experimentation.md) · Next: [65 · CSP-Style Concurrency](./65-csp-style-concurrency.md) →
