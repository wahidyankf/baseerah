# 57 · Agentic AI (By Example, Python †)

**prd row**: Pass 3 · Build for the Real World · By Example · Python † · Learn 157 / Drill 257 ·
...
← Previous: [56 · Creating AI-Powered Apps](./56-creating-ai-powered-apps.md) · Next: [58 · IT / Application Security](./58-it-and-application-security.md) →
