...
| `dbup-sqlite`                     | Phase 2 backend project file                                                                                                                          | Exact NuGet version selected under the policy                                         | Determine Path A/B/C at Phase 2                                                   | **PENDING — not selected**                                                                                                                              | `evidence/phase-2-dependency-adoption.md` and this table record the selected version and full clearance result before the project-file edit.                                                                                                                    |
| `Microsoft.Data.Sqlite`           | Phase 2 backend project file                                                                                                                          | Exact NuGet version selected under the policy                                         | Determine Path A/B/C at Phase 2                                                   | **PENDING — not selected**                                                                                                                              | `evidence/phase-2-dependency-adoption.md` and this table record the selected version and full clearance result before the project-file edit.                                                                                                                    |
| `vite`                            | Phase 4 frontend package manifest                                                                                                                     | Exact npm version selected under the policy                                           | Determine Path A/B/C at Phase 4                                                   | **PENDING — not selected**                                                                                                                              | `evidence/phase-4-dependency-adoption.md` and this table record the selected version and full clearance result before the manifest edit.                                                                                                                        |
| `@vitejs/plugin-react`            | Phase 4 frontend package manifest                                                                                                                     | Exact npm version selected under the policy                                           | Determine Path A/B/C at Phase 4                                                   | **PENDING — not selected**                                                                                                                              | `evidence/phase-4-dependency-adoption.md` and this table record the selected version and full clearance result before the manifest edit.                                                                                                                        |
| `msw`                             | Phase 4 frontend package manifest                                                                                                                     | Exact npm version selected under the policy                                           | Determine Path A/B/C at Phase 4                                                   | **PENDING — not selected**                                                                                                                              | `evidence/phase-4-dependency-adoption.md` and this table record the selected version and full clearance result before the manifest edit.                                                                                                                        |
| `docker.io/library/node`          | Phase 4 `apps/beaver-nest-fe/Dockerfile`; Phase 5 `apps/beaver-nest-be/Dockerfile` build stage and `infra/dev/beaver-nest-app/Dockerfile.fe.dev`      | Exact Node LTS tag and immutable digest selected under the policy                     | Confirm the current Node LTS line, then use Path A; otherwise determine Path B/C  | **PENDING — image pin not selected**                                                                                                                    | Before its Dockerfile rewrite, `evidence/phase-4-dependency-adoption.md` or `evidence/phase-5-container-base-images.md`, and this table, record the selected tag/digest, full clearance, and every `FROM` occurrence that consumes it.                          |
| `mcr.microsoft.com/dotnet/sdk`    | Phase 5 `apps/beaver-nest-be/Dockerfile` build stage, `apps/beaver-nest-be/Dockerfile.integration`, and `infra/dev/beaver-nest-app/Dockerfile.be.dev` | Exact .NET LTS SDK tag and immutable digest selected under the policy                 | Confirm the current .NET LTS line, then use Path A; otherwise determine Path B/C  | **PENDING — image pin not selected**                                                                                                                    | Before any of the three Dockerfile rewrites, `evidence/phase-5-container-base-images.md` and this table record the selected tag/digest, full clearance, and every `FROM` occurrence that consumes it.                                                           |
| `mcr.microsoft.com/dotnet/aspnet` | Phase 5 combined-image runtime stage                                                                                                                  | Exact .NET LTS ASP.NET tag and immutable digest selected under the policy             | Confirm the current .NET LTS line, then use Path A; otherwise determine Path B/C  | **PENDING — image pin not selected**                                                                                                                    | `evidence/phase-5-container-base-images.md` and this table record the selected `FROM` tag/digest and clearance result before Dockerfile rewrite.                                                                                                                |

### Security Waivers

No Path C waiver exists at plan authoring. If no Path A or Path B candidate is CVE-clean, the
executor must add the policy-required waiver here before merge: package/image and exact pin; CVE ID
and NVD or GHSA URL; severity; pinned-release date; justification; and executing engineer or agent
identity. The same waiver must be added to `docs/reference/security-waivers.md`; KEV `dateAdded`,
`knownRansomwareCampaignUse`, and qualifying EPSS data must also be recorded when applicable.
