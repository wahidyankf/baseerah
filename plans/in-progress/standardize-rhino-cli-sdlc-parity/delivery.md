...
- [ ] [AI] Confirm **all four gates** run only `test:quick` (+ validators) and **never** integration/e2e — acceptance: `grep -n 'test:integration\|test:e2e' .husky/pre-commit .husky/pre-push .github/workflows/pr-quality-gate.yml .github/workflows/main-ci.yml` returns no gate invocation.
...
- [ ] [AI] Confirm all four primer gates run only `test:quick` (+ validators), never integration/e2e — acceptance: `grep -n 'test:integration\|test:e2e' .husky/pre-commit .husky/pre-push .github/workflows/pr-quality-gate.yml .github/workflows/main-ci.yml` returns no gate invocation.
...
- [ ] [AI] Confirm all four infra gates run only `test:quick` (+ validators + IaC), never integration/e2e — acceptance: `grep -n 'test:integration\|test:e2e' .husky/pre-commit .husky/pre-push .github/workflows/pr-quality-gate.yml .github/workflows/main-ci.yml` returns no gate invocation.
