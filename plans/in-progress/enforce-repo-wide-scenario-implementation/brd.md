...
| ---------------------------------------------------------------------------------------------- | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Turning on fail-on-skip / the cross-check surfaces a large backlog of unimplemented scenarios. | High     | Expected. Phase 0 sizes it; the rollout is batched per-project per-phase, each a green gate; genuinely-not-ready scenarios use `@wip` (exempt, visible) rather than silent skip. |
