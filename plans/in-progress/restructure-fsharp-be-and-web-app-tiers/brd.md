...
| ose-be (was ose-app-be) has five bounded contexts; porting drops one silently                                                                                    | Lost functionality                         | Port context-by-context against an enumerated list; Phase 3 gate checks all five bound                                                                                                                      |
