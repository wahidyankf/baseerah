...
[Delivery Mode](../../../repo-governance/conventions/structure/plans.md#delivery-mode) section. [Repo-grounded]
...
- **DD-10 (DEVIATION — documented exception): `[AI]` auto-merges Phase 5/6/7 PRs instead of the
  ...
  amend the [Delivery Mode convention](../../../repo-governance/conventions/structure/plans.md#delivery-mode)'s
...
- **DD-11 (DEVIATION — documented exception): Plan Archival is committed via direct push to `main`
  ...
  [Delivery Mode convention](../../../repo-governance/conventions/structure/plans.md#delivery-mode).
