 ...
 * `http://localhost:3202` for local dev. Trailing slash trimmed so concat
 * never produces `//app/...`.
 */

const RAW_BASE_URL = process.env.WEB_BASE_URL || "http://localhost:3202";
 ...
 *
 * Examples:
 *   appPath("home")          → "http://localhost:3202/app/home"
 *   appPath("workout/finish")→ "http://localhost:3202/app/workout/finish"
 *   appPath("")              → "http://localhost:3202/app/home" (default tab)
 */
