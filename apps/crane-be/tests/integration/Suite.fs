module CraneBe.Tests.Integration.Suite
...
/// Returns loaded @integration Gherkin scenarios, or a single no-op placeholder when none can be loaded.
        ...
        if Directory.Exists(gherkinRoot) then
            ...
            |> Seq.collect (fun path ->
                try
                    ...
                    let filtered = filterByTag "integration" content
