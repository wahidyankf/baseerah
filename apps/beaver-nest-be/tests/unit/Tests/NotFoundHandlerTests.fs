...
// @covers specs/apps/beaver-nest/behavior/beaver-nest-be/gherkin/routing/unknown-api.feature:Unknown API path returns JSON not SPA HTML
[<Fact>]
...
// @covers specs/apps/beaver-nest/behavior/beaver-nest-be/gherkin/routing/greeting-retirement.feature:Greeting route is no longer part of the API
[<Fact>]
