// Generated from: ../../specs/apps/ose/behavior/platform-web/gherkin/app-shell/theme.feature
...
test.use({
  ...
  $uri: [({}, use) => use('../../specs/apps/ose/behavior/platform-web/gherkin/app-shell/theme.feature'), { scope: 'test', box: true }],
