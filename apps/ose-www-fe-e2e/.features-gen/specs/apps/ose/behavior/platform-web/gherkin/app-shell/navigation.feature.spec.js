...
test.describe('Navigation', () => {
  ...
  test('Header contains navigation links', { tag: ['@unit', '@e2e'] }, async ({ Given, Then, And, page }) => { 
  ...
  test('Breadcrumb shows ancestor hierarchy without current page', { tag: ['@unit', '@e2e'] }, async ({ Given, Then, And, page }) => { 
  ...
  test('Previous and next navigation between updates', { tag: ['@unit', '@e2e'] }, async ({ Given, Then, And, page }) => { 
