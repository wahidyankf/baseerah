// Generated from: ../../specs/apps/ose/behavior/platform-be/gherkin/seo/seo.feature
...
test.use({
  ...
  $uri: [({}, use) => use('../../specs/apps/ose/behavior/platform-be/gherkin/seo/seo.feature'), { scope: 'test', box: true }],
