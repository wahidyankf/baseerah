// Generated from: ../../specs/apps/ose/behavior/platform-be/gherkin/health/health.feature
...
test.use({
  ...
  $uri: [({}, use) => use('../../specs/apps/ose/behavior/platform-be/gherkin/health/health.feature'), { scope: 'test', box: true }],
