// Generated from: ../../specs/apps/ose/behavior/platform-be/gherkin/search/search.feature
...
test.use({
  ...
  $uri: [({}, use) => use('../../specs/apps/ose/behavior/platform-be/gherkin/search/search.feature'), { scope: 'test', box: true }],
