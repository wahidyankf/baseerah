// Generated from: ../../specs/apps/ose/behavior/platform-be/gherkin/rss-feed/rss-feed.feature
...
test.use({
  ...
  $uri: [({}, use) => use('../../specs/apps/ose/behavior/platform-be/gherkin/rss-feed/rss-feed.feature'), { scope: 'test', box: true }],
