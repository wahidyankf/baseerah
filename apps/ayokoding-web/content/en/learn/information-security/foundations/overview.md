...
draft: false
description: "Security foundations for software engineers — start here before specializing into Red Team, Blue Team, or CISO"
tags: ["foundations", "it-security", "security-engineer", "learning-path"]
---

Security foundations cover the hands-on skills every engineer needs before specializing into
a role. Whether you go on to red team, blue team, or security leadership, these are the
controls, tools, and concepts you will encounter in every security conversation.

## Why Start Here

The role tracks (Red Team, Blue Team, CISO) assume you already know how firewalls work, what
TLS does, how to read logs, and what a CVE means. This track builds that baseline through 85
annotated examples — all code-first, no security background required.
...
- [Red Team](/en/learn/information-security/roles/red-team/overview) — think like an attacker
