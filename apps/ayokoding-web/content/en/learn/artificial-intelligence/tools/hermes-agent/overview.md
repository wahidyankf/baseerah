...
See the [By Example tutorial](/en/learn/artificial-intelligence/tools/hermes-agent/by-example) for 80 heavily annotated examples covering 95% of Hermes Agent.

## How This Tutorial Is Organized

### [By Example](/en/learn/artificial-intelligence/tools/hermes-agent/by-example)
...
See [Example 27](/en/learn/artificial-intelligence/tools/hermes-agent/by-example/beginner) for the complete migration guide with directory mapping and configuration format conversion.

## Related Tools

- **[OpenClaw](/en/learn/artificial-intelligence/tools/openclaw)** — Alternative AI agent platform focused on tool-chaining
- **[Claude Code](/en/learn/artificial-intelligence/tools/claude-code)** — Anthropic's AI-powered coding assistant

## Next Steps

Start with the [By Example tutorial](/en/learn/artificial-intelligence/tools/hermes-agent/by-example) to master Hermes Agent through 80 heavily annotated, runnable examples.
