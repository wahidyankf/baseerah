...
See the [By Example tutorial](/en/learn/artificial-intelligence/tools/openclaw/by-example) for 80 heavily annotated examples covering 95% of OpenClaw.
...
- **[Beginner](/en/learn/artificial-intelligence/tools/openclaw/by-example/beginner)** (Examples 1-27) — Installation, CLI, JSON5 configuration, built-in tools, simple skills (0-40% coverage)
...
- **[Hermes Agent](/en/learn/artificial-intelligence/tools/hermes-agent)** — Alternative AI agent platform focused on self-improving skill learning
- **[Claude Code](/en/learn/artificial-intelligence/tools/claude-code)** — Anthropic's AI-powered coding assistant

## Next Steps

Start with the [By Example tutorial](/en/learn/artificial-intelligence/tools/openclaw/by-example) to master OpenClaw through 80 heavily annotated, runnable examples.
