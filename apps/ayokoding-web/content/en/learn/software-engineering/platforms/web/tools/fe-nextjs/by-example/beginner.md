...
**Next**: [Intermediate examples](/en/learn/software-engineering/platforms/web/tools/fe-nextjs/by-example/intermediate) for production patterns, authentication, database integration, and advanced data fetching.
