 ...
 *
 * Covers: specs/apps/organiclever/behavior/organiclever-web/gherkin/workout-session/workout-session.feature
 *
...
const feature = await loadFeature(
  path.resolve(
    __dirname,
    "../../../../../../specs/apps/organiclever/behavior/organiclever-web/gherkin/workout-session/workout-session.feature",
  ),
);
