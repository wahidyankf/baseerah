 ...
 *
 * Covers: specs/apps/organiclever/behavior/organiclever-web/gherkin/stats/progress-screen.feature
 *
...
const feature = await loadFeature(
  path.resolve(
    __dirname,
    "../../../../../../specs/apps/organiclever/behavior/organiclever-web/gherkin/stats/progress-screen.feature",
  ),
);
