...
draft: false
description: "Learn TypeScript Effect SQL through 80 annotated code examples covering 95% of the library - ideal for experienced developers building production database migration layers with @effect/sql"
