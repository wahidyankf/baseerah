...
type linksCheckOseUnitSteps struct {
	cmdErr     error
	cmdOutput  string
	mockResult *links.CheckResult
}

func (s *linksCheckOseUnitSteps) before(_ context.Context, _ *godog.Scenario) (context.Context, error) {
	verbose = false
	quiet = false
	output = "text"
...
func (s *linksCheckOseUnitSteps) after(_ context.Context, _ *godog.Scenario, _ error) (context.Context, error) {
	checkLinksFn = links.CheckLinks
	outputLinksJSONFn = links.OutputLinksJSON
	return context.Background(), nil
}

func (s *linksCheckOseUnitSteps) oseWebContentWhereAllInternalLinksResolveCorrectly() error {
...
func (s *linksCheckOseUnitSteps) oseWebContentWithALinkPointingToANonExistentPage() error {
	s.mockResult = &links.CheckResult{
		CheckedCount: 1,
		ErrorCount:   1,
...
func (s *linksCheckOseUnitSteps) oseWebContentWithOnlyExternalHTTPSLinks() error {
	s.mockResult = &links.CheckResult{
		CheckedCount: 1,
		ErrorCount:   0,
		BrokenLinks:  nil,
...
func (s *linksCheckOseUnitSteps) captureRun() {
	r, w, _ := os.Pipe()
...
func (s *linksCheckOseUnitSteps) theDeveloperRunsLinksCheck() error {
	s.captureRun()
	return nil
}

func (s *linksCheckOseUnitSteps) theDeveloperRunsLinksCheckWithJSONOutput() error {
	output = "json"
	s.captureRun()
	return nil
}

func (s *linksCheckOseUnitSteps) theCommandExitsSuccessfully() error {
	if s.cmdErr != nil {
...
func (s *linksCheckOseUnitSteps) theCommandExitsWithAFailureCode() error {
	if s.cmdErr == nil {
...
func (s *linksCheckOseUnitSteps) theOutputIsValidJSON() error {
