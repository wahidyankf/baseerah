...
var linksCheckCmd = &cobra.Command{
	Use:   "check",
	Short: "Validate internal links in ose-web content",
	Long: `Validate all internal links in ose-web markdown content.
...
apps-ose-web-link-checker AI agent for external link validation.`,
	Example: `  ose-cli links check
...
func init() {
	...
	linksCheckCmd.Flags().StringVar(&linksContentDir, "content", "apps/ose-web/content", "content directory path")
}
