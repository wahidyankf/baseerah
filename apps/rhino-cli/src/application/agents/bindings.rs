...
pub const AMAZONQ_AGENT_DEFINITION: &str = ".amazonq/cli-agents/beaver-nest-default.json";
...
mod tests {
    ...
    fn emit_writes_both_files_with_exact_bytes() {
        ...
        let def = std::fs::read(root.join(".amazonq/cli-agents/beaver-nest-default.json")).unwrap();
    ...
    fn emit_agent_definition_is_valid_json() {
        ...
        assert_eq!(parsed["name"], "beaver-nest-default");
