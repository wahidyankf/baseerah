...
pub const AMAZONQ_AGENT_DEFINITION: &str = ".amazonq/cli-agents/baseerah-default.json";
...
mod tests {
    ...
    fn emit_writes_both_files_with_exact_bytes() {
        ...
        let def = std::fs::read(root.join(".amazonq/cli-agents/baseerah-default.json")).unwrap();
    ...
    fn emit_agent_definition_is_valid_json() {
        ...
        let raw =
            std::fs::read_to_string(dir.path().join(".amazonq/cli-agents/baseerah-default.json"))
                .unwrap();
        let parsed: serde_json::Value = serde_json::from_str(&raw).unwrap();
        assert_eq!(parsed["name"], "baseerah-default");
