...
// @covers specs/apps/crane/behavior/crane-cli/gherkin/media/table-check.feature:detect command identifies tables in layout text
[<Fact>]
...
// @covers specs/apps/crane/behavior/crane-cli/gherkin/media/table-check.feature:Present table with matching structure produces no finding
[<Fact>]
...
// @covers specs/apps/crane/behavior/crane-cli/gherkin/media/table-check.feature:Missing table produces a CRITICAL finding
[<Fact>]
...
// @covers specs/apps/crane/behavior/crane-cli/gherkin/media/table-check.feature:Table with wrong row count produces a MEDIUM finding
[<Fact>]
