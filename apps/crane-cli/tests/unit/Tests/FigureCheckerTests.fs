...
// @covers specs/apps/crane/behavior/crane-cli/gherkin/media/figure-check.feature:Figure with Mermaid block produces no finding
[<Fact>]
...
// @covers specs/apps/crane/behavior/crane-cli/gherkin/media/figure-check.feature:Figure with no representation produces a HIGH finding
[<Fact>]
...
// @covers specs/apps/crane/behavior/crane-cli/gherkin/media/figure-check.feature:Figure with placeholder produces no finding
[<Fact>]
