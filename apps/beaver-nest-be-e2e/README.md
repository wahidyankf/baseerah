...
Playwright-BDD backend E2E tests for beaver-nest-be.
...
| Command                                        | Description                    |
| ---------------------------------------------- | ------------------------------ |
| `nx run beaver-nest-be-e2e:test:e2e`           | Run BE E2E tests headlessly    |
| `nx run beaver-nest-be-e2e:test:e2e:ui`        | Run with interactive UI        |
| `nx run beaver-nest-be-e2e:test:e2e:report`    | View HTML report               |
| `nx run beaver-nest-be-e2e:specs:e2e:coverage` | Check Gherkin scenario binding |
