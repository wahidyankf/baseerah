// `hue` drives the decorative 10%-alpha icon tint; `ink` is the darker,
// WCAG-AA-compliant (≥4.5:1 on the light card background) variant used for the
// title text.
const MODULES = [
  {
    hue: "oklch(56% 0.13 195)",
    ink: "oklch(42% 0.1 195)",
