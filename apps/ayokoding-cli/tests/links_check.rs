...
//! to the real `ayokoding-cli` binary via `assert_cmd`.
...
// @covers specs/apps/ayokoding/behavior/ayokoding-cli/gherkin/links/links-check.feature:A content directory with all valid Hugo-path links passes validation
...
// @covers specs/apps/ayokoding/behavior/ayokoding-cli/gherkin/links/links-check.feature:A broken internal link is detected and reported
...
// @covers specs/apps/ayokoding/behavior/ayokoding-cli/gherkin/links/links-check.feature:External URLs are not validated
...
fn when_run_links_check(w: &mut LinksCheckWorld) {
    let assert = Command::cargo_bin("ayokoding-cli")
...
// @covers specs/apps/ayokoding/behavior/ayokoding-cli/gherkin/links/links-check.feature:JSON output produces structured results
...
fn feature_dir() -> PathBuf {
    ...
    manifest
        .join("../../specs/apps/ayokoding/behavior/ayokoding-cli/gherkin/links")
        .canonicalize()
