...
- **{identifier}**: Specific update type
  ...
  - `month-YYYY-MM` - Monthly update posts for `oseplatform-web` (human-readable, sorts lexicographically)
...
### Monthly Updates (`month-YYYY-MM`)

Monthly recap posts focused on the `oseplatform-web` marketing site, synthesized from that month's commit history and any new content landed under `ose-public/apps/oseplatform-web/`. Paired with a corresponding in-site content file under `ose-public/apps/oseplatform-web/` (produced by the `social-monthly-update-maker` agent via an ose-public subrepo worktree).

**Example**: `2026-04-30__linkedin__ose-update-month-2026-04.md`
...
- **[Content Guidelines](../repo-governance/conventions/writing/quality.md)** - Content quality standards
- **[OSE Platform Web](../apps/ose-www/README.md)** - Main website documentation
...
- **[OSE Platform Web](../apps/ose-www/README.md)** - Main marketing website
- **[Content Quality Standards](../repo-governance/conventions/writing/quality.md)** - Writing guidelines
- **[Emoji Usage](../repo-governance/conventions/formatting/emoji.md)** - Emoji in content
- **[Repository Architecture](../repo-governance/repository-governance-architecture.md)** - Overall project structure
