...
As of this vision document's writing, BeaverNest is a walking skeleton: a stateless F#/Giraffe
backend (`beaver-nest-be`) and a Next.js frontend (`beaver-nest-fe`) proving the engineering harness
