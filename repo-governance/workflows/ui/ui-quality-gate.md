...
inputs:
  - name: scope
    type: string
    description: Files or directories to validate (e.g., "libs/web-ui/", "apps/baseerah-fe/src/components/")
    required: false
...
User: "Run UI quality gate for apps/baseerah-fe/src/components/ui/"
```
