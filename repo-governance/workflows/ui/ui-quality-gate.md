...
inputs:
  - name: scope
    type: string
    description: Files or directories to validate (e.g., "libs/web-ui/", "apps/beaver-nest-fe/src/components/")
    required: false
...
User: "Run UI quality gate for apps/beaver-nest-fe/src/components/ui/"
```
