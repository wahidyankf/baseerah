...
- **plan**: Project planning documents — establishment, two-pager→backlog idea promotion, multi-repo parity planning (with and without composite execution), quality gate, and execution
