...
| [Repository Harness Compatibility Quality Gate](repo/README.md)              | Detect external drift between supported coding-agent harness conventions and the platform-binding catalog (per-harness web research) and fix it, iterate to double-zero         | repo-harness-compatibility-checker, repo-harness-compatibility-fixer                                                                                                    | Medium     |
