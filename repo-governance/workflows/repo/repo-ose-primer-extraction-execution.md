...
- Product E2E suites (`ayokoding-www-*-e2e`, `organiclever-*-e2e`, `ose-www-*-e2e`) pass.
...
- [Plan: 2026-04-25 ose-primer-separation](../../../plans/done/2026-04-25__ose-primer-separation/README.md) — the plan orchestrating this workflow.
