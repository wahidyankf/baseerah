...
| `2025-11-01-beaver-nest-fe-vercel-outage.md`            | `2025-11-01__beaver-nest-fe__vercel.md` | Double underscore is plans-folder style, not post-mortem style |
...
- **Sev-1**: Production database migration gone wrong corrupts user records across all BeaverNest
  accounts; Vercel deployment serves a broken build to every visitor of the production `beaver-nest-fe` site.
- **Sev-2**: GitHub Actions CI is blocked for all PRs due to a broken Nx Cloud integration;
  a platform-wide Vercel incident takes `beaver-nest-fe` and every other OSE-family production site
...
| `2025-11-01-beaver-nest-fe-vercel-deploy-failure.md`         | `2025-11-01__beaver-nest-fe__vercel.md`          | Double underscores are for `plans/` folders, not post-mortems |
| `2025-09-14-beaver-nest-be-coverage-threshold-regression.md` | `2025-09-14-BeaverNestBe-Coverage.md`            | Uppercase components                                          |
