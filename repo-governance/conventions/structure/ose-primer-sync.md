...
- **`strip-product-sections`** — Remove H2/H3 sections whose heading or body references a product app (`OrganicLever`, `AyoKoding`, `OSE Platform`, or paths `apps/(organiclever|ayokoding)-*/`, `apps/(ose-web|ose-web-be-e2e|ose-web-fe-e2e|ose-cli)\b`). For tables, remove rows naming product apps. For lists, remove bullets naming product apps. Preserve paragraph-level generic content untouched.
...
| `apps/ose-web`                                                                                                    | `neither`                   | —                        | Product-specific OSE Platform web app; not in primer scope.                                                                                                |
| `apps/ose-web-be-e2e`                                                                                             | `neither`                   | —                        | Product-specific E2E suite; not in primer scope.                                                                                                           |
| `apps/ose-web-fe-e2e`                                                                                             | `neither`                   | —                        | Product-specific E2E suite; not in primer scope.                                                                                                           |
| `apps/rhino-cli`                                                                                                  | `propagate`                 | `identity`               | Generic repository-management CLI; MIT-licensable and useful in template.                                                                                  |
| `apps/ose-cli`                                                                                                    | `neither`                   | —                        | Product-specific OSE Platform site maintenance CLI.                                                                                                        |
...
| `libs/rust-commons`                                                                                               | `propagate`                 | `identity`               | Generic Rust utilities.                                                                                                                                    |
...
| `libs/web-ui`                                                                                                     | `neither`                   | —                        | Consumed only by `organiclever-web` (product-specific app); propagating UI tokens would leak product theming.                                              |
| `libs/web-ui-token`                                                                                               | `neither`                   | —                        | Same rationale as `libs/web-ui`.                                                                                                                           |
| `libs/golang-link-commons`                                                                                        | `neither` (deleted)         | —                        | Deleted 2026-05-25; all consumers migrated to Rust.                                                                                                        |
...
| `specs/apps/ose/**`                                                                                               | `neither`                   | —                        | Product specs (OSE Application + OSE Platform Web unified tree).                                                                                           |
| `specs/apps/rhino/**`                                                                                             | `propagate`                 | `identity`               | Generic CLI specs.                                                                                                                                         |
| `repo-governance/principles/**`                                                                                   | `bidirectional`             | `identity`               | Universal values; improvements from either side surface.                                                                                                   |
...
| `repo-governance/conventions/structure/licensing.md`                                                              | `neither`                   | —                        | Licensing convention is `ose-public`-specific; covers the per-directory MIT approach for this repo only.                                                   |
| `repo-governance/conventions/structure/ose-primer-sync.md`                                                        | `neither`                   | —                        | This very convention is `ose-public`-specific; the primer does not need a sync-with-itself convention.                                                     |
...
| `repo-governance/workflows/repo/repo-ose-primer-*.md`                                                             | `neither`                   | —                        | Sync-orchestration workflows live in `ose-public` only.                                                                                                    |
...
| `docs/reference/related-repositories.md`                                                                          | `neither`                   | —                        | Describes the full ose-public ecosystem (ose-public, ose-primer, ose-infra) from `ose-public`'s perspective; not relevant in primer itself.                |
...
| `archived/**`                                                                                                     | `neither`                   | —                        | Archived product apps; frozen, product-specific history.                                                                                                   |
...
2. Enumerates every immediate subdirectory of `apps/`, `libs/`, `specs/apps/`, `repo-governance/*/`, `docs/*/`, `.claude/agents/` (as files), `.claude/skills/`.
