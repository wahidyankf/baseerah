...
- **`strip-product-sections`** — Remove H2/H3 sections whose heading or body references a product app (`OrganicLever`, `AyoKoding`, `OSE Platform`, or paths `apps/(organiclever|ayokoding)-*/`, `apps/(ose-www|ose-www-be-e2e|ose-www-fe-e2e|ose-cli)\b`). For tables, remove rows naming product apps. For lists, remove bullets naming product apps. Preserve paragraph-level generic content untouched.
...
| `apps/ose-www`                                                                                                    | `neither`                   | —                        | Product-specific OSE Platform web app; not in primer scope.                                                                                                |
| `apps/ose-www-be-e2e`                                                                                             | `neither`                   | —                        | Product-specific E2E suite; not in primer scope.                                                                                                           |
| `apps/ose-www-fe-e2e`                                                                                             | `neither`                   | —                        | Product-specific E2E suite; not in primer scope.                                                                                                           |
