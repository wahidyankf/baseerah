...
- **Universal applicability** - Applies to **all tutorial content** (docs/, ayokoding-web, ose-web, anywhere)
...
**Note**: These naming standards apply universally to all tutorial content regardless of location. Platform-specific details (frontmatter fields, weight values) are covered in site-specific skills.
