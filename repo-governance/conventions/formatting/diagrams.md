...
[`plans/ideas/mermaid-state-label-render-clipping-warn.md`](https://github.com/wahidyankf/ose-public/blob/main/plans/ideas/q2-not-urgent-important/mermaid-state-label-render-clipping-warn.md).
