...
- [Linking Convention](./formatting/linking.md) - Standards for linking between documentation files using GitHub-compatible markdown. Defines two-tier formatting for rule references (first mention = markdown link, subsequent mentions = inline code). `rhino-cli docs validate-links` validates `#fragment` anchor references in addition to file-existence checks
...
- [Why It Matters Content Convention](./writing/why-it-matters-content.md) - Prohibits corporate case studies, fabricated platform scenarios, and unsourced numeric claims in `**Why It Matters**:` sections of ayokoding-web tutorials; requires theoretical explanations only. Applies to all by-example and in-the-field content in both English and Indonesian. **Agents**: apps-ayokoding-web-by-example-maker, apps-ayokoding-web-in-the-field-maker, apps-ayokoding-web-by-example-checker, apps-ayokoding-web-in-the-field-checker, apps-ayokoding-web-by-example-fixer, apps-ayokoding-web-in-the-field-fixer
...
Tutorial creation, structure, naming, and content standards applying to **all tutorial content** (docs/, ayokoding-web, ose-web, anywhere). These conventions **build upon and extend** the writing conventions above.
