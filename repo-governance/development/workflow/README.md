...
- [Dependency Bump Stability & Safety Policy](./dependency-bump-policy.md) - Three-path decision tree (LTS, 60-day soak, security waiver) governing every dependency bump across the polyglot monorepo. Mandates exact pinning, CVE clearance via NVD/GHSA/Snyk, cutoff-date computation in writing, and waiver documentation in `tech-docs.md` for Path C overrides
