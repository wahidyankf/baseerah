...
git then reports the entire skipped delta as a pending mass revert. This happened for real in this
repository — see the [Terminal Reconcile](#terminal-reconcile) table's "Why this form" column and
